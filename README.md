...
## Intro
The aim of this project is to make an decentralized application where independent and trustful elections can be held. The app has several features implemented and all bundled into one React application.
